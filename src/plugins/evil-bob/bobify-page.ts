...
import evilBob16 from "@/media/bob-icon-16x16.svg?raw";
// @ts-expect-error typescript doesnt know ?raw imports. Can be fixed with declare global module for ?raw files
import evilBob32 from "@/media/bob-icon-32x32.svg?raw";
// @ts-expect-error typescript doesnt know ?raw imports. Can be fixed with declare global module for ?raw files
import evilBob48 from "@/media/bob-icon-48x48.svg?raw";
// is probably too large import evilBob128 from "@/media/bob-icon-128x128.svg?raw"
